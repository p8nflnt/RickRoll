<#
.SYNOPSIS
    Display ASCII animation loop and Console-Beep rendition of
...
Function Invoke-Astley {
    ...
    $MusicScript = {
        ...
        Function Invoke-Tune {
            ...
            # INSERT NOTES BELOW #
            Invoke-Note -Note $Note.D5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.FS5  -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.A5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.G5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.FS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Half
            Invoke-Note -Note $Note.A4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.A4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.D5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            ...
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.REST -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.A4   -Duration $Duration.Half
            Invoke-Note -Note $Note.REST -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.A5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.REST -Duration $Duration.Eighth
            Invoke-Note -Note $Note.A5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.REST -Duration $Duration.Quarter
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            ...
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.A4   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.REST -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            ...
            Invoke-Note -Note $Note.E5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.FS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.REST -Duration $Duration.Quarter
            Invoke-Note -Note $Note.D5   -Duration $Duration.Half
            Invoke-Note -Note $Note.E5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.FS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.Eighth
            ...
            Invoke-Note -Note $Note.E5   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.REST -Duration $Duration.Half
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
            ...
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.FS5  -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.FS5  -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedQuarter
            Invoke-Note -Note $Note.A4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.E5   -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.A4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.D5   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.E5   -Duration $Duration.Eighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.A4   -Duration $Duration.Eighth
            ...
            Invoke-Note -Note $Note.D5   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.A5   -Duration $Duration.Quarter
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Eighth
            Invoke-Note -Note $Note.D5   -Duration $Duration.DottedEighth
            Invoke-Note -Note $Note.CS5  -Duration $Duration.Sixteenth
            Invoke-Note -Note $Note.B4   -Duration $Duration.Eighth
    ...
    # Execute MusicScript as background job
    $music = Start-Job -ScriptBlock $MusicScript

    # Credit for visual animation components below this point to Filip Mårtensson @ https://github.com/fenwikk
    # Reverse-engineered and modified for this use-case by Payton Flint @ https://github.com/p8nflnt
    ...
    while ($music.State -ne 'Completed') {
